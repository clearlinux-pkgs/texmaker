...
Source0  : https://www.xm1math.net/texmaker/texmaker-5.1.4.tar.bz2
...
%prep
%setup -q -n texmaker-5.1.4
cd %{_builddir}/texmaker-5.1.4
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
qmake6 QMAKE_CFLAGS+=-fno-lto QMAKE_CXXFLAGS+=-fno-lto
...
ASFLAGS="$CLEAR_INTERMEDIATE_ASFLAGS"
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS"
export SOURCE_DATE_EPOCH=1719424784
rm -rf %{buildroot}
